...
describe("camera coordination", () => {
  it(
    "lets a direct gesture cancel application motion and blocks later automatic focus",
    () => {
  ...
  it(
    "does not let automatic narration interrupt an active application transition",
    () => {
  ...
  it(
    "retargets an active transition for the newest explicit location/body/fragment action",
    () => {
