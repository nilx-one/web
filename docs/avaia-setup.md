...
shows what identity contract 8 answered with, sends back what a person typed,
and lets the service be the authority on whether that is an address an Avaia may
hold. A rejection is repeated in the service's own terms — a discriminator that
